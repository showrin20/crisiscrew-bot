...
export const FireIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.5 19c-3 0-5.5-1-5.5-4 0-1.4.5-3 2.5-3.5S10 11 11.5 11c1.5 0 2.813.5 3.5 1.5S17 14.5 17 16c0 2-1 4-4.5 4-1.312 0-2.5-.5-3-1z" />
  </svg>
);
...
export const CircleIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
...
export const BotIcon: React.FC = () => (
    <div className="h-8 w-8 rounded-full bg-gray-600 flex items-center justify-center text-red-400">
